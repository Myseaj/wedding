...
const tasks = [
  ...
  {id:"6",short:"Foto mit weitgereister Person",short_de:"Foto mit weitgereister Person",short_pl:"Zdjęcie z osobą z najdalszej podróży",task:"Mach ein Foto mit dem Brautpaar und einem Gast, der am weitesten gereist ist.",task_de:"Mach ein Foto mit dem Brautpaar und einem Gast, der am weitesten gereist ist.",task_pl:"Zrób zdjęcie z parą młodą i gościem, który przyjechał najdalej."},
